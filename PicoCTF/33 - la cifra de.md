...
## Solucion
```
nagubi-picoctf@webshell:~$ nc jupiter.challenges.picoctf.org 5726 
Encrypted message:
...
Podemos observar algo entre corchetes lo que posiblemente sea la bandera por lo tanto usaremos un vinegre solver obteniendo el texto desencyptado y por lo tanto la bandera:
...
## Referencias
- [decoder](https://www.dcode.fr/cifrado-vigenere)